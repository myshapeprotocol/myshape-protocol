...
function SectionHeading({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-white/30 text-[11px] tracking-[0.4em] uppercase mb-10 text-center hover:text-[#90c8ff]/50 transition-colors cursor-default"
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={item.title}
                onMouseEnter={e => { playTick(500, "sine", 0.04, 0.01); e.currentTarget.style.borderColor = "rgba(144,200,255,0.3)"; e.currentTarget.style.background = "rgba(144,200,255,0.02)"; e.currentTarget.querySelector("h3")!.style.color = "rgba(144,200,255,0.9)"; e.currentTarget.querySelector("p")!.style.color = "rgba(255,255,255,0.6)"; }}
                onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(144,200,255,0.08)"; e.currentTarget.style.background = "transparent"; e.currentTarget.querySelector("h3")!.style.color = "rgba(144,200,255,0.55)"; e.currentTarget.querySelector("p")!.style.color = "rgba(255,255,255,0.35)"; }}
                ...
                <h3 className="text-[#90c8ff]/55 text-[12px] tracking-[0.2em] uppercase mb-4 font-bold transition-colors">{item.title}</h3>
        ...
        <section className="mb-24">
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {[
              ...
              <div key={item.label}
                onMouseEnter={e => { playTick(500, "sine", 0.04, 0.01); e.currentTarget.style.borderColor = "rgba(144,200,255,0.3)"; e.currentTarget.style.background = "rgba(144,200,255,0.02)"; const els = e.currentTarget.querySelectorAll("div,p"); els.forEach(el => { (el as HTMLElement).style.color = el.tagName === "DIV" ? "rgba(144,200,255,0.85)" : "rgba(255,255,255,0.55)"; }); }}
        ...
        <section className="text-center py-12 border-t border-white/[0.05]">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/genesis"
              ...
              className="px-10 py-3.5 border border-[#90c8ff]/30 text-[#90c8ff]/70 text-[11px] tracking-[0.3em] uppercase font-mono hover:bg-[#90c8ff]/[0.04] hover:text-white hover:border-[#90c8ff]/50 transition-all"
            ...
            <Link href="/dashboard"
              ...
              className="px-10 py-3.5 border border-[#90c8ff]/20 text-[#90c8ff]/45 text-[11px] tracking-[0.3em] uppercase font-mono hover:border-[#90c8ff]/35 hover:text-[#90c8ff]/70 hover:bg-[#90c8ff]/[0.03] transition-all">
              View Dashboard →
            </Link>
          </div>
        </section>
