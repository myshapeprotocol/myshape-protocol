...
export const metadata: Metadata = {
  ...
  description: "Empirical evidence for the MyShape Protocol: PES benchmarks, attack model verification, motion-signature examples, and live verification results.",
  openGraph: {
    title: "MyShape Evidence — Verifiable Protocol Proofs",
    description: "Empirical evidence: PES benchmarks, attack model, motion signatures, and live verification results.",
