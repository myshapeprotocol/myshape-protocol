...
const COMPARISON_DATA: ComparisonRow[] = [
  ...
  { dimension: "Privacy Model", myShape: "ZK-Presence — verify human without identifying who", worldcoin: "ZK identity — verify uniqueness without revealing iris", civic: "Selective disclosure of credentials", trip: "ZK attestation with reputation scoring" },
