...
const ARCHITECTURE = [
  ...
  { layer: "L4 — Proof Layer", detail: "Continuity: PoP + MP + EP → composite proof. 128-512 bytes. < 1ms verification." },
