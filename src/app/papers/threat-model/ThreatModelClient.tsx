    ...
    <div className="min-h-screen bg-[#02040a] text-[#f8feff] font-mono selection:bg-[#90c8ff]/30">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 pt-24 md:pt-28 pb-16">
        <div className="space-y-4 mb-14">
          ...
          <p className="text-white/15 text-[10px] tracking-[0.15em] mt-2">By MyShape Protocol · V1.0 · June 2026 · Security Analysis — Not an Academic Paper</p>
        </div>
        ...
        <section className="mb-14">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left border-collapse border border-white/5">
              <thead><tr className="border-b border-white/10 bg-white/[0.02]"><th className="p-3 text-white/30 text-[9px] tracking-[0.3em] uppercase font-normal">Tier</th><th className="p-3 text-white/30 text-[9px] tracking-[0.3em] uppercase font-normal">Cost</th><th className="p-3 text-white/30 text-[9px] tracking-[0.3em] uppercase font-normal">Attack Types</th><th className="p-3 text-white/30 text-[9px] tracking-[0.3em] uppercase font-normal">Max Success</th></tr></thead>
              <tbody>
                {COST_MODEL.map((c, i) => (
          ...
          <p className="mt-3 text-white/20 text-[9px] tracking-[0.1em] italic">MyShape security property: the cost to forge presence exceeds the value of forging it.</p>
        </section>
        ...
        <section className="mt-14 text-center border-t border-white/[0.04] pt-10">
          <div className="text-white/30 text-[10px] tracking-[0.25em] uppercase mb-3 hover:text-[#90c8ff]/50 transition-colors cursor-default" onMouseEnter={() => playTick(450, "sine", 0.03, 0.01)}>Cite This Document</div>
          <p className="text-white/25 text-[10px] leading-relaxed font-mono hover:text-white/40 transition-colors cursor-default" onMouseEnter={() => playTick(450, "sine", 0.03, 0.01)}>MyShape Protocol. "Threat Model v1.0." June 2026. https://www.myshape.com/papers/threat-model</p>
        </section>
      </div>
      <ProtocolFooter />
    </div>
