        ...
        <div className="note-layout">
          ...
          <article className="note-article">
            ...
            <section className="note-section" id="status">
              ...
              <p>
                <strong>Historical — superseded by CPS-0001 v1.0-RC1.</strong> This RFC describes the earlier
                weighted multi-engine aggregation semantics. CPS-0001 v1.0-RC1 now uses two-stage verification:
            ...
            <section className="note-section" id="validation">
              ...
              <p>
                ...
                in <Link href="/lab/research/notes/003-cross-modal-binding" className="text-[#90c8ff]/70 hover:text-[#90c8ff] underline">RN-003 — Cross-Modal Binding</Link>.
              </p>
            </section>
            ...
            <RelatedResearch
              supportedBy={[
                { id: "PE-001", label: "Causal Coupling", href: "/lab/research/causal-coupling" },
                { id: "VS-001", label: "Verification Session", href: "/lab/research/protocol-verify" },
                { id: "EE-003", label: "Gyroscope Challenge", href: "/lab/research/challenge-response" },
              ]}
              relatedNotes={[
                { id: "RN-003", label: "Cross-Modal Binding", href: "/lab/research/notes/003-cross-modal-binding" },
            ...
            <div className="mt-16 pt-8 border-t border-white/[0.04] text-center">
              <Link href="/lab/research" className="text-white/35 text-[11px] tracking-[0.2em] uppercase hover:text-white/55 transition-colors">
                ← Research Hub
              </Link>
            </div>
          </article>
