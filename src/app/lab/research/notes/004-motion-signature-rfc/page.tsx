...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://thecontinuitylab.org/research/notes/004-motion-signature-rfc" },
  openGraph: {
    title: "RFC-0001 — Motion Signature Format · The Continuity Lab",
    description:
    ...
    url: "https://thecontinuitylab.org/research/notes/004-motion-signature-rfc",
