        ...
        <div className="note-layout">
          ...
          <article className="note-article">
            ...
            <section className="note-section" id="abstract">
              ...
              <p>
                This document is normative and builds on <Link href="/lab/research/notes/004-motion-signature-rfc" className="text-[#90c8ff]/70 hover:text-[#90c8ff] underline">RFC-0001 (Motion Signature Format)</Link>.
              </p>
            </section>
            ...
            <RelatedResearch
              ...
              relatedNotes={[
                { id: "RFC-0001", label: "Motion Signature Format", href: "/lab/research/notes/004-motion-signature-rfc" },
                { id: "RN-003", label: "Cross-Modal Binding", href: "/lab/research/notes/003-cross-modal-binding" },
                { id: "FD-001", label: "Frame Rate Hypothesis", href: "/lab/research/notes/005-failure-report-10fps" },
              ]}
            />
