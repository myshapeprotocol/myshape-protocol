...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://thecontinuitylab.org/research/notes/006-continuity-proof-rfc" },
  openGraph: {
    title: "RFC-0002 — Continuity Proof Format · The Continuity Lab",
    ...
    url: "https://thecontinuitylab.org/research/notes/006-continuity-proof-rfc",
