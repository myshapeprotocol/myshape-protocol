...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://thecontinuitylab.org/research/notes/001-the-continuity-problem" },
  openGraph: {
    title: "RN #001 — The Continuity Problem",
    description: "Why proving 'I am still me' may become the missing primitive of the AI era.",
    url: "https://thecontinuitylab.org/research/notes/001-the-continuity-problem",
