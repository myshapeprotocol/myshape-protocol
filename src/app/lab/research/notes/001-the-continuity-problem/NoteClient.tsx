        ...
        <div className="note-layout">
          ...
          <RelatedResearch
            ...
            referencedDecisions={[
              ...
              { id: "DL-002", label: "Establish The Continuity Lab", href: "/lab/research" },
            ]}
            openQuestions={[
          ...
          <div className="note-footer note-print-stage note-print-delay-8">
            <p className="note-footer-text">
              ...
              {" · "}
              <Link href="/lab/research/notes/002-pes-benchmark" onMouseEnter={() => playTick(480, "sine", 0.03, 0.018)}>Next: RN #002 — PES Benchmark →</Link>
            </p>
