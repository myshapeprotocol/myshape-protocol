...
export const POSTS: PostEntry[] = [
  ...
  { slug: "/blog/the-day-identity-stopped-meaning-presence", series: "Continuity Lab", title: "The Day Identity Stopped Meaning Presence", subtitle: "Twenty years ago, appearing on screen meant someone was probably there. Today, it doesn't. What broke — and what comes next.", date: "2026.07.26", tags: ["continuity","identity","AI","presence"], featured: true, category: "Continuity" },
  { slug: "/blog/ai-didnt-break-identity-it-broke-continuity", series: "Continuity Lab", title: "AI Didn't Break Identity. It Broke Continuity.", subtitle: "Everyone is talking about deepfakes, voice clones, and AI agents. But the real thing that broke isn't who you are — it's whether you're still here.", date: "2026.07.26", tags: ["continuity","AI","deepfakes","protocol"], featured: true, category: "Continuity" },
  { slug: "/blog/recognition-is-not-the-problem-anymore", series: "Continuity Lab", title: "Recognition Is Not the Problem Anymore", subtitle: "Companies are racing to fix recognition. But the vulnerability isn't how you look — it's the assumption that appearance proves presence.", date: "2026.07.26", tags: ["recognition","security","continuity","entropy"], featured: true, category: "Security" },
  { slug: "/blog/what-if-verification-returned-evidence", series: "Continuity Lab", title: "What If Verification Returned Evidence Instead of Yes/No?", subtitle: "Every SDK you've ever used returns true or false. We think that's the wrong data model — and it's holding back an entire category of applications.", date: "2026.07.26", tags: ["SDK","evidence","protocol","developer"], featured: true, category: "Continuity" },
  { slug: "/blog/http-has-headers-tls-has-certificates-what-does-continuity-have", series: "Continuity Lab", title: "HTTP Has Headers. TLS Has Certificates. What Does Continuity Have?", subtitle: "Every protocol layer has a data format for its core concern. Continuity has none. Here's what we're building to fix that.", date: "2026.07.26", tags: ["protocol","CPS-0001","RFC","standards"], featured: true, category: "Standards" },
  // ── Featured ──
  ...
  // ── Security ──
  { slug: "/blog/the-post-recognition-era-2026", series: "GENESIS 011", title: "The Post-Recognition Era", subtitle: "Why 2026 is the year we stop relying on static recognition. Static identity created the largest unchangeable database.", date: "2026.07.03", tags: ["recognition","security","privacy"], category: "Security" },
  { slug: "/blog/motion-vs-recognition-why-appearance-is-not-a-key", series: "GENESIS 005", title: "Motion vs Static Recognition", subtitle: "Static recognition is broken. Motion offers a post-recognition alternative that is generative and non-replayable.", date: "2026.07.03", tags: ["motion","recognition","authentication"], category: "Security" },
