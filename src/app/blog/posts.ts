...
export const POSTS: PostEntry[] = [
  // ── Continuity Lab Series (2026.07.26) ──
  { slug: "/blog/mdx/the-day-identity-stopped-meaning-presence", series: "Continuity Lab", title: "The Day Identity Stopped Meaning Presence", subtitle: "Twenty years ago, appearing on screen meant someone was probably there. Today, it doesn't. What broke — and what comes next.", date: "2026.07.26", tags: ["continuity","identity","AI","presence"], featured: true, category: "Continuity" },
  { slug: "/blog/mdx/ai-didnt-break-identity-it-broke-continuity", series: "Continuity Lab", title: "AI Didn't Break Identity. It Broke Continuity.", subtitle: "Everyone is talking about deepfakes, voice clones, and AI agents. But the real thing that broke isn't who you are — it's whether you're still here.", date: "2026.07.26", tags: ["continuity","AI","deepfakes","protocol"], featured: true, category: "Continuity" },
  { slug: "/blog/mdx/your-face-isnt-the-problem-anymore", series: "Continuity Lab", title: "Your Face Isn't the Problem Anymore", subtitle: "Biometrics companies are racing to fix facial recognition. But the vulnerability isn't your face — it's the assumption that a face proves presence.", date: "2026.07.26", tags: ["biometrics","security","continuity","entropy"], featured: true, category: "Security" },
  { slug: "/blog/mdx/what-if-verification-returned-evidence", series: "Continuity Lab", title: "What If Verification Returned Evidence Instead of Yes/No?", subtitle: "Every SDK you've ever used returns true or false. We think that's the wrong data model — and it's holding back an entire category of applications.", date: "2026.07.26", tags: ["SDK","evidence","protocol","developer"], featured: true, category: "Continuity" },
  { slug: "/blog/mdx/http-has-headers-tls-has-certificates-what-does-continuity-have", series: "Continuity Lab", title: "HTTP Has Headers. TLS Has Certificates. What Does Continuity Have?", subtitle: "Every protocol layer has a data format for its core concern. Continuity has none. Here's what we're building to fix that.", date: "2026.07.26", tags: ["protocol","CPS-0001","RFC","standards"], featured: true, category: "Standards" },
  // ── Featured ──
  ...
  // ── Security ──
  { slug: "/blog/the-post-biometric-era-2026", series: "GENESIS 011", title: "The Post-Biometric Era", subtitle: "Why 2026 is the year we stop scanning faces. Biometrics created the largest unchangeable password database in history — now compromised.", date: "2026.07.03", tags: ["biometrics","security","privacy"], category: "Security" },
  { slug: "/blog/motion-vs-biometrics-why-your-face-is-not-a-password", series: "GENESIS 005", title: "Motion vs Biometrics", subtitle: "Static biometrics are broken. Motion offers a post-biometric alternative that is generative, non-replayable, and privacy-preserving.", date: "2026.07.03", tags: ["motion","biometrics","authentication"], category: "Security" },
  ...
  { slug: "/blog/ai-agent-identity-how-autonomous-agents-prove-who-they-are", series: "GENESIS 009", title: "AI Agent Continuity", subtitle: "How autonomous agents prove they are still themselves. Agent declaration, continuity binding, human-AI coexistence.", date: "2026.07.03", tags: ["agents","AI","continuity"], category: "Guides" },
];
