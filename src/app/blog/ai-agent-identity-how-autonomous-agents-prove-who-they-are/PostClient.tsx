        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 md:px-6" style={{ paddingTop: "8rem", paddingBottom: "6rem" }}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <Link href="/blog/proof-of-personhood-vs-proof-of-continuity" onMouseEnter={() => playTick(700, "sine", 0.08, 0.02)} className="block p-4 border border-[#90c8ff]/10 hover:border-[#90c8ff]/25 transition-all">
                <p className="text-white/50 text-[10px] tracking-[0.1em]">PoP vs PoC</p>
                <p className="text-white/20 text-[8px] tracking-[0.1em] mt-1">Two problems, two protocols →</p>
              </Link>
              ...
              <Link href="/agent" onMouseEnter={() => playTick(700, "sine", 0.08, 0.02)} className="block p-4 border border-[#90c8ff]/10 hover:border-[#90c8ff]/25 transition-all">
                <p className="text-white/50 text-[10px] tracking-[0.1em]">Agent Declaration</p>
                <p className="text-white/20 text-[8px] tracking-[0.1em] mt-1">Register your agent →</p>
              </Link>
            </div>
          </div>
          <div className="mt-12 p-8 border border-[#90c8ff]/15 bg-[#90c8ff]/[0.02] text-center space-y-4">
            <p className="text-white/40 text-[10px] tracking-[0.15em] uppercase">Register Your Agent</p>
            <p className="text-white/25 text-[10px] leading-relaxed max-w-md mx-auto">The Agent Declaration protocol is live. Register your autonomous agent in the MyShape identity mesh — cryptographic proof of provenance and continuity.</p>
            <div className="flex justify-center gap-4 pt-2">
              <Link href="/agent" onMouseEnter={() => playTick(700, "sine", 0.08, 0.02)} className="px-6 py-2 border border-[#90c8ff]/30 text-[#90c8ff]/60 text-[9px] tracking-[0.2em] uppercase hover:bg-[#90c8ff]/10 hover:text-[#90c8ff] transition-all">Agent Registration →</Link>
              <Link href="/developers" onMouseEnter={() => playTick(700, "sine", 0.08, 0.02)} className="px-6 py-2 border border-[#90c8ff]/15 text-[#90c8ff]/40 text-[9px] tracking-[0.2em] uppercase hover:border-[#90c8ff]/30 hover:text-[#90c8ff]/60 transition-all">SDK Docs →</Link>
            </div>
          </div>
