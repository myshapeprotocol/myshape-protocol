    ...
    <div className="min-h-screen bg-[#02040a] text-[#f8feff] font-mono selection:bg-cyan-500/30">
      ...
      <article className="relative z-10 max-w-3xl mx-auto px-6 pt-32 pb-24">
        ...
        <div className="space-y-10 text-[15px] leading-[1.85] font-light text-white/55">
          ...
          {/* The Experiment */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">The Experiment</h2>
          ...
          {/* The Results */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">The Results</h2>
          <div className="border p-5 my-6" style={{ borderColor: "rgba(144,200,255,0.1)" }}>
...
Human—AI Gap: 0.3960`}
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={r.tag} className="border p-4" style={{ borderColor: "rgba(144,200,255,0.08)" }}>
                <span className="text-cyan-400/60 font-mono text-[11px] tracking-[0.1em]">{r.tag}</span>
                <span className="text-white/35 text-[13px] ml-3">{r.detail}</span>
              </div>
            ))}
          </div>

          {/* Why This Matters */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">Why This Matters</h2>
          ...
          {/* How It Works */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">How It Works</h2>
          ...
          {/* Run It */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">Run It Yourself</h2>
          <p>The core engine is open source:</p>
          <div className="border p-5 my-4" style={{ borderColor: "rgba(144,200,255,0.1)", background: "rgba(2,4,10,0.6)" }}>
            <pre className="text-cyan-400/40 text-[11px] leading-relaxed font-mono whitespace-pre">
...
cargo run --release --bin myshape-demo -- --verbose`}
          ...
          {/* The Deeper Truth */}
          <h2 className="text-xl font-bold tracking-tighter text-white pt-6">The Deeper Truth</h2>
          ...
          <div className="flex flex-wrap gap-4 pt-4 text-[11px]">
            <a href="/whitepaper" className="border px-4 py-2 text-cyan-400/60 hover:text-cyan-300 hover:border-cyan-400/40 transition-all" style={{ borderColor: "rgba(144,200,255,0.2)" }}>
              Read the Whitepaper →
            </a>
            <a href="https://x.com/myshapeprotocol" target="_blank" rel="noopener noreferrer" className="border px-4 py-2 text-cyan-400/60 hover:text-cyan-300 hover:border-cyan-400/40 transition-all" style={{ borderColor: "rgba(144,200,255,0.2)" }}>
              @myshapeprotocol →
            </a>
          </div>
          ...
          <div className="mt-16 pt-10 border-t border-white/[0.05]">
            ...
            <a href="/blog/stored-identity-vs-generated-presence"
              className="block border border-cyan-400/10 p-5 hover:border-cyan-400/25 transition-all group">
