...
------------------------------------------------------- */
const MouseTracker = ({ mouseRef }: { mouseRef: React.MutableRefObject<{ x: number; y: number; set: (x: number, y: number) => void; clone: () => { x: number; y: number } }> }) => {
...
/* -------------------------------------------------------
   Core Being — 脊柱型能量生命体
------------------------------------------------------- */
const CoreBeing = ({ scrollEnergyRef, mouseRef }: { scrollEnergyRef: React.MutableRefObject<number>; mouseRef: React.MutableRefObject<{ x: number; y: number; set: (x: number, y: number) => void; clone: () => { x: number; y: number } }> }) => {
